...
for k=1:num_iter
    ...
    [Ecost,Ehit,EgradJ,EgradSh] = mean_controlled_hittingtime( x0,BETA,a,b,POT,coeffs(k,:),leftlim,rightlim,n);
...
[Ecost,Ehit,EgradJ,EgradSh] = mean_controlled_hittingtime( x0,BETA,a,b,POT,coeffs(num_iter+1,:),leftlim,rightlim,n);
grad_tildeI = EgradJ + (Ecost+Ehit)*EgradSh;
...
h4=figure(4);
clf
plot(x_,zmat1(1,:),'b',x_,(basisvalues*opt_coeffs),'r',x_,zmat1(11,:),'k')
...
h5=figure(5);
clf
plot(x(KK),V(KK),'b',x(KK),V(KK)+2*F(KK),'k')
hold on
xlabel('x')
