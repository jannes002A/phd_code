...
N = 1000; %dt=1/N;
M = 10; %Anzahl der Trajektorieren
...
Bty1=zeros(1,N);
    ...
    for j=1:N
        ...
        [~,dxf_l,dyf_l]=HomotopieTest2D(Xtempx,Xtempy,lambda);
...
HVP=zeros(1,N+1);
HVP(1)  =   HomotopieTest2D(Xzerox1,Xzeroy1,lambda);
for i=2:N+1
    HVP(i) = HomotopieTest2D(Xemx1(i-1),Xemy1(i-1),lambda);
end
